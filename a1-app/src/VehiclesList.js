    ...
    render() {
        ...
        return (
            <div>
                ...
                <p><Link className='btn btn-default' to='/Vehicles/create'>Add a new Vehicles</Link></p>
...
const TableRow = props => {
    ...
    return (
        <tr>
            ...
            <td><Link className='btn btn-default' to={`/Vehicles/detail/${u.id}`}>Details</Link>&nbsp;&nbsp;
            <Link className='btn btn-warning' to={`/Vehicles/edit/${u.id}`}>Edit</Link>&nbsp;&nbsp;
            <Link className='btn btn-danger' to={`/Vehicles/delete/${u.id}`}>Delete</Link></td>
        </tr>
    );
}
